...
<div class="emp-designation-form">
    ...
    <div class="row">
        <div class="col-md-4">
            <?= $form->field($model, 'emp_id')->dropDownList(
                ArrayHelper::map(EmpInfo::find()->where(['delete_status'=>1])->all(),'emp_id','emp_name'), ['prompt'=>'Select Employee Name']
            )?>
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-4">
             <?= $form->field($model, 'group_by')->dropDownList([ 'Faculty' => 'Faculty', 'Non-Faculty' => 'Non-Faculty', ], ['prompt' => 'Group By']) ?>
        </div>
        <div class="col-md-4">
            <?= $form->field($model, 'emp_salary')->textInput() ?>
        </div>
        <div class="col-md-4">
             <?= $form->field($model, 'designation_status')->dropDownList([ 'Promotion' => 'Promotion', 'Demotion' => 'Demotion', ], ['prompt' => 'Select Designation Status']) ?>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
