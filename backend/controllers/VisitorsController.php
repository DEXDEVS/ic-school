...
use common\models\VisitorsSearch;
...
class VisitorsController extends Controller
{
            ...
            if($request->isGet){
                ...
                $model->visitor_photo = UploadedFile::getInstance($model,'visitor_photo');
                    if(!empty($model->visitor_photo)){
                        $imageName = $model->visitor_name.'_photo'; 
                        $model->visitor_photo->saveAs('uploads/'.$imageName.'.'.$model->visitor_photo->extension);
                        //save the path in the db column
                        $model->visitor_photo = 'uploads/'.$imageName.'.'.$model->visitor_photo->extension;
                    } else {
                       $model->visitor_photo = 'uploads/'.'std_default.jpg'; 
                    }
                ...
                return [
                    ...
                    'title'=> "Create new Visitors",
                    'content'=>'<span class="text-success">Create Visitors success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Visitors model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Visitors model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
